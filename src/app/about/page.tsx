        ...
        <div className="sm:flex-[5] lg:flex-[4]">
          <div className="max-w-[550px] md:max-w-[400px] mx-auto flex flex-col gap-4 mb-96 sm:mb-40 lg:mb-0">
            ...
            <figure
              ...
              // className="absolute mt-[400px] max-w-full w-[100vw] right-0 md:-ml-10 xl:ml-0 h-[600px] py-20 md:w-[600px] md:h-[600px] lg:w-[700px] lg:h-[670px] md:-left-16 md:-bottom-[70px] md:z-10"
            >
              <Image
                src={Mike}
                alt="Michael Ayeni"
